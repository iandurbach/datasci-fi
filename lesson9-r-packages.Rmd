...
Note that there is are two fashions of roxygen. The newer one is showcased 
above. It allows you to include markdown syntax for links, bullet points ect.
...
above example, we tests whether multiplication works. In particular, we check 
